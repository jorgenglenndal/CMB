#ifndef _GSLSPLINE_lin_HEADER
#define _GSLSPLINE_lin_HEADER
#ifdef _USEOPENMP
#include <omp.h>
#endif
...
#define _FIDUCIAL_INTERPOL_TYPE    gsl_interp_linear
#endif
#ifndef _FIDUCIAL_INTERPOL_TYPE_2D
#define _FIDUCIAL_INTERPOL_TYPE_2D gsl_interp2d_bilinear
#endif
...
class Spline_lin{
  ...
  public:
    ...
    Spline_lin(const Spline_lin& rhs);
    Spline_lin& operator=(const Spline_lin& rhs);
